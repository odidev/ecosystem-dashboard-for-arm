...
description: Bazel is an open-source build tool developed by Google that automates the process of building, testing and deploying software, allowing developers to scale their projects efficiently and reliably.
download_url: https://github.com/bazelbuild/bazel/releases
works_on_arm: true
supported_minimum_version:
    version_number: 3.4.0
    release_date: 13/07/2020
